        ...
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item absolute opacity-0" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url('https://images.unsplash.com/photo-1523381294911-8d3cead13475?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-right" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url('https://plus.unsplash.com/premium_photo-1718913931807-4da5b5dd27fa?q=80&w=872&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
            ...
            <div class="carousel-item absolute opacity-0" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-bottom"
                    style="background-image: url('https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
            ...
            @foreach ($products as $product)
                {{-- <a href="#" class="group block">
                    <img src="{{ asset('storage/' . $product->gambar) }}"
                        alt="" class="h-[350px] w-full object-cover sm:h-[450px]" />
                ...
                {{-- <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col w-30 h-30                ">
                    <a href="#">
                        <img class="w-full h-full object-cover aspect-square" src="{{ asset('storage/' . $product->gambar) }}">
                        <div class="pt-3 flex items-center justify-between">
                            <h2 class="text-2xl">{{ $product->nama_produk }}</h2>
                ...
                <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col gap-4">
                    <a href="#" class="block bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
                        <!-- Gambar Produk -->
                        <img class="w-full h-80 object-cover" src="{{ asset('storage/' . $product->gambar) }}" alt="{{ $product->nama_produk }}">
                        ...
                        <div class="p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <svg class="h-6 w-6 fill-current text-gray-500 hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    ...
                                    c1.563,1.571,1.564,4.025,0.002,5.588L12,18.586l-6.793-6.793C3.645,10.23,3.646,7.776,5.205,6.209 
